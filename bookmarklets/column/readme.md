...
次いで、以下は Chrome における手順ですが、Firefox でも大筋は一緒です（調べてください）。

1. manifest.json と [ソースコード](https://github.com/nakayama-kazuki/2020/blob/master/bookmarklets/copy-column-v2.txt)  を copy-column.js の名称で適当なフォルダに保存
2. Chrome の設定画面を開く
3. デベロッパーモードに変更する
