...
ところが ISP の Comcast はこの動きに [警戒感を表明](https://www.vice.com/en_us/article/9kembz/comcast-lobbying-against-doh-dns-over-https-encryption-browsing-data) しました。<br />
...
しかし、この主張は [プラットフォーマーからの反撃](https://blog.mozilla.org/blog/2019/11/01/asking-congress-to-examine-isp-data-practices/) を受けます。<br />
...
まずは [RFC 8484](https://tools.ietf.org/html/rfc8484)を確認してみましょう。<br />
...
今回は 127.0.0.1 の DocumentRoot 上に DoH 応答を生成する自前 DoH サービス（doh.php）を用意しました。<br />
...
自前 DoH サービスは DoH 応答とあわせて Set-Cookie を応答します。<br />
これが some-doh-provider.com ドメインの Cookie として扱われるのかどうかを後程確認します。<br />
ちなみに今回は some-web-service.com も 127.0.0.1 に解決しています。<br />
