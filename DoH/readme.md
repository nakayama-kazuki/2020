...
[cloudflare の Example](https://developers.cloudflare.com/1.1.1.1/dns-over-https/wireformat/) には set-cookie を用いる例が見つかります。<br />
...
いよいよ自前 DoH サービスのドメイン（test.doh）のコンテンツを閲覧してみます。<br />
...
が有効ならば Firefox は ttps://test.doh/request-headers.php 閲覧の際に

```http
Cookie: doh=49
```

を送信するはずですが、果たして結果は ...<br />

![](06.png)

どうやら Firefox は Cookie を送信しなかったようです。<br />
