...
[cloudflare の Example](https://developers.cloudflare.com/1.1.1.1/dns-over-https/wireformat/) にも set-cookie を用いる例が見つかります。<br />
...
また Cookie のブロック機能は使わないのでチェックを外します。<br />
...
が有効ならば Firefox はコンテンツ閲覧の際に

```http
Cookie: doh=49
```

を送信し apache_request_headers() にその内容が含まれるはずですが、果たして結果は ...<br />

![](06.png)

どうやら Firefox は Cookie を送信しなかったようです。<br />
Cookie も保存されていませんでした。<br />
